...
async def main():
    ...
    sb_esports_markets = await sb_scraper.SPORTSBET_scraper(market_type='Match Betting')
    ...
    br_basketball_markets = await br_scraper.BETRIGHT_scraper(market_type ='Money Line')
