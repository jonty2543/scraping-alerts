...
class BetrSportsScraper:
    ...
    async def Betr_scrape_union(self, comp):
        """
        NPC BlueBet Win Market Scraper.
        """
        win_market = {}
        ...
        async with async_playwright() as p:
            ...
            # Use page.request.get instead of fetch inside page.evaluate
